...
class EVE_SolarSystem {
public:
    EVE_SolarSystem(unsigned long id, std::string name, float security);
    EVE_SolarSystem() = default;
    ...
    std::vector<unsigned long>* getConnectedSystems() const;
